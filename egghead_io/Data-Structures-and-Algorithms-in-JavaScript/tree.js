...
// Trees are graphs without cycles (Ağaçlar döngüsüz grafiklerdir)
// A cycle is three or more nodes connected in a circuitous path (Bir döngü, dolambaçlı bir yola bağlı üç veya daha fazla düğümdür.)

// Graphs === have neighbors, not hierarchical (hiyerarşik değil, komşuları var)
// Trees === have children, are hierarchical (çocuk sahibi, hiyerarşik)
